...
},{"process":"../../../../usr/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/gsap/TweenLite.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
function (_Highway$Transition) {
  _inherits(Default, _Highway$Transition);
...
var Gallery =
/*#__PURE__*/
function (_Highway$Transition2) {
  _inherits(Gallery, _Highway$Transition2);
  ...
  _createClass(Gallery, [{
    ...
    value: function _in(_ref3) {
      ...
      var tl = new TimelineMax();
      tl.staggerFromTo(galleryMenu, 0.7, {
        opacity: 0,
        y: 9
      }, {
        opacity: 1,
    ...
    value: function out(_ref4) {
      ...
      var tl = new TimelineMax();
      tl.staggerFromTo(galleryMenu, 0.5, {
        opacity: 1,
        y: 0
      }, {
        opacity: 0,
...
var Gal =
/*#__PURE__*/
function (_Highway$Transition3) {
  _inherits(Gal, _Highway$Transition3);

  function Gal() {
    _classCallCheck(this, Gal);

    return _possibleConstructorReturn(this, _getPrototypeOf(Gal).apply(this, arguments));
  }

  _createClass(Gal, [{
    key: "in",
    value: function _in(_ref5) {
      var done = _ref5.done;
      var tl = new TimelineMax();
      tl.to(header, 0.5, {
        opacity: 0,
